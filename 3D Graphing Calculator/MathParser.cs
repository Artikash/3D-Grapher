...
namespace _3D_Graphing
{
    ...
    {
        // I just copy pasted a bunch of code for math parsing, god knows how it works
        // but it does work, and work pretty well, so fuck it.
        ...
        /// </summary>
        private static readonly Dictionary<string, string> supportedOperators =
        ...
        /// </summary>
        private static readonly Dictionary<string, string> supportedFunctions =
            new Dictionary<string, string>
            {
                { "sqrt", Sqrt },
                { "√", Sqrt },
        ...
        private static readonly Dictionary<string, string> supportedConstants =
            new Dictionary<string, string>
            {
        ...
        private static bool isRadians = true;
        ...
        {
            return (float)Calculate(expression.Replace("x", x.ToString()).Replace("y", y.ToString()));
        }
        /// <summary>
